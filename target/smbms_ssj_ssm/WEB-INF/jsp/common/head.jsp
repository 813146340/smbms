...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/billlist.html?method=query">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/gotoProvider">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/userlist.html">用户管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/gotoPwd">密码修改</a></li>
