...
function deleteProvider(obj){
	$.ajax({
		type:"GET",
		url:path+"/provider/delPro/"+obj.attr("proid"),
		dataType:"text",
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/provider/viewPro/"+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/provider/gotoModify/"+ obj.attr("proid");
	});
